                    ...
                    <form>
                      ...
                      <div className="row g-3 mb-3">
                        ...
                        <div className="col-12 col-sm-6">
                          ...
                          <input type="email" className="form-control" defaultValue="rahul@mail.com" />
                        </div>
                        <div className="col-12 col-sm-6">
                          <label className="form-label">Phone</label>
                          <input type="tel" className="form-control" defaultValue="+91 90000 11111" />
                        </div>
                        <div className="col-12 col-sm-6">
                          <label className="form-label">Location</label>
                          <input type="text" className="form-control" defaultValue="Delhi, India" />
                        </div>
                      </div>
                      ...
                      <div className="row g-3 mb-3">
                        <div className="col-12">
                          ...
                          <textarea
                            ...
                            rows="4"
                            defaultValue="Sharma Tech Pvt Ltd — hiring freelancers for web and mobile products."
                          />
                        </div>
                      </div>
